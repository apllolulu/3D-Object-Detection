...
IMG_ROOT = '/media/ora/362b0807-5852-4af1-8f79-03a42964afb0/xy/3DObjectDetection/voxelnet/data/dataset/training/image_2/'
PC_ROOT = '/media/ora/362b0807-5852-4af1-8f79-03a42964afb0/xy/3DObjectDetection/voxelnet/data/dataset/training/new_velodyne/'#原始
CALIB_ROOT = '/media/ora/362b0807-5852-4af1-8f79-03a42964afb0/xy/3DObjectDetection/voxelnet/data/dataset/training/calib/'
PC_NEW_ROOT = '/media/ora/362b0807-5852-4af1-8f79-03a42964afb0/xy/3DObjectDetection/voxelnet/data/dataset/training/velodyne/'#crop


for frame in tqdm(range(0, 7481)): #7481
    ...
    #output_name = PC_NEW_ROOT + str(frame) + '.bin'
    output_name = PC_NEW_ROOT +'%06d.bin' % frame
