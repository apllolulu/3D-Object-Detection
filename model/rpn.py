...
class MiddleAndRPN:
    def __init__(self, input, alpha=1.5, beta=1, sigma=3, training=True, name=''):
        # 特征学习网络的输出 [batchsize, 10, 400/200, 352/240, 128] 
        self.input = input
        self.training = training
        # groundtruth  each anchor box, represent as △x, △y, △z, △l, △w, △h, rotation
